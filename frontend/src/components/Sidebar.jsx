...
const Sidebar = () => {
  ...
  const filteredUsers=searchBarInput? users.filter((user)=>user.fullName.toLowerCase().includes(searchBarInput.toLowerCase())) :users;
  ...
  return (
    ...
    >
      <div className="pb-5">
        ...
        <div className="bg-[#282142] rounded-full flex items-center justify-between gap-2 py-3 px-4 mt-5">
